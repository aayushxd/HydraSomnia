...
import 'package:healthapp/utils/helpers/common.dart';

import '../../core/styles/app_color.dart';

class TodaySleepScheduleRow extends StatefulWidget {
  final AlarmModel alarm;
  const TodaySleepScheduleRow({super.key, required this.alarm});
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    DateTime.parse(widget.alarm.alarmTime ?? "").HHMM(),
                    style: const TextStyle(
                      color: AppColors.blackColor,
                      fontSize: 14,
                    ),
                ...
                SizedBox(
                  ...
                  child: Transform.scale(
                    ...
                    child: CustomAnimatedToggleSwitch<bool>(
                      current: widget.alarm.isActive ?? false,
