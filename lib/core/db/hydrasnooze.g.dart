...
class UserTableField extends FilterBase {
  UserTableField(UserTableFilterBuilder usertableFB) : super(usertableFB);
...
class UserTableFilterBuilder extends ConjunctionBase {
  ...
  Map<String, dynamic> toListPrimaryKeySQL([bool buildParams = true]) {
    ...
    _retVal['sql'] = 'SELECT `uid` FROM UserTable WHERE ${qparams.whereString}';
...
class AlarmModelField extends FilterBase {
  AlarmModelField(AlarmModelFilterBuilder alarmmodelFB) : super(alarmmodelFB);
...
class AlarmModelFilterBuilder extends ConjunctionBase {
  ...
  Map<String, dynamic> toListPrimaryKeySQL([bool buildParams = true]) {
    ...
    _retVal['sql'] = 'SELECT `id` FROM AlarmModel WHERE ${qparams.whereString}';
    _retVal['args'] = qparams.whereArguments;
    return _retVal;
  }
